...
public class DryerR1A3 extends ClockDomain{
	...
	private int tutu__582217300;
	private int tutu__590488798;
	private int tutu__580678304;
	private int tutu__263517790;
	private int S755 = 1;
	private int S521 = 1;
	private int S753 = 1;
	private int S523 = 1;
	...
	private int[] tdone = new int[85];
		public void thread1081606048(int [] tdone, int [] ends){
          if(tdone[9] != 1){
            switch(S753){
              case 0 : 
              active[9]=0;
...
if(appliancePowerDryerR1A3_o.get_preempted()){
                                        tutu__590488798 = 0;
                                        tutu__590488798 = appliancePowerDryerR1A3_o.get_preempted() ? appliancePowerDryerR1A3_o.refresh() : 0;
                    S530=1;
active[9]=1;
                    ends[9]=1;
tdone[9]=1;
...
if(appliancePowerDryerR1A3_o.get_w_s() == appliancePowerDryerR1A3_o.get_w_r()){
                                            tutu__582217300 = 0;
                                            tutu__582217300 = appliancePowerDryerR1A3_o.get_w_s();
                                            tutu__582217300++;
                                            appliancePowerDryerR1A3_o.set_w_s(tutu__582217300);
...
tdone[9]=1;
                ...
                switch(S530){
                  ...
                  if(appliancePowerDryerR1A3_o.get_preempted()){
                                        tutu__263517790 = 0;
                                        tutu__263517790 = appliancePowerDryerR1A3_o.get_preempted() ? appliancePowerDryerR1A3_o.refresh() : 0;
                    S530=1;
active[9]=1;
                    ends[9]=1;
tdone[9]=1;
                    ...
                    switch(S525){
                      ...
                      if(appliancePowerDryerR1A3_o.get_w_s() == appliancePowerDryerR1A3_o.get_w_r()){
                                                tutu__580678304 = 0;
                                                tutu__580678304 = appliancePowerDryerR1A3_o.get_w_s();
                                                tutu__580678304++;
                                                appliancePowerDryerR1A3_o.set_w_s(tutu__580678304);
                                                appliancePowerDryerR1A3_o.set_value(new Integer(power_thread_9));
                        S525=1;
if(appliancePowerDryerR1A3_o.get_w_s() == appliancePowerDryerR1A3_o.get_w_r()){
                                                    ends[9]=2;
...
public void thread1078912805(int [] tdone, int [] ends){
          if(tdone[8] != 1){
            switch(S521){
              case 0 : 
              active[8]=0;
...
public void thread1079682303(int [] tdone, int [] ends){
          if(tdone[9] != 1){
            S753=1;
S523=0;
active[9]=1;
...
public void thread1087762030(int [] tdone, int [] ends){
          if(tdone[8] != 1){
            S521=1;
if(onSignal.getprestatus()){
                            System.out.println("Dryer ON signal received");
...
RUN: while(true){
          ...
          thread1087762030(tdone,ends);
          thread1079682303(tdone,ends);
          int biggest1078528057 = 0;
          if(ends[8]>=biggest1078528057){
            biggest1078528057=ends[8];
}
          if(ends[9]>=biggest1078528057){
            biggest1078528057=ends[9];
}
          if(biggest1078528057 == 1){
            active[7]=1;
            ends[7]=1;
            break RUN;
            }
                    case 2 : 
                    powerReceive_7.setClear();
          thread1078912805(tdone,ends);
          thread1081606048(tdone,ends);
          int biggest1081990797 = 0;
          if(ends[8]>=biggest1081990797){
            biggest1081990797=ends[8];
}
          if(ends[9]>=biggest1081990797){
            biggest1081990797=ends[9];
}
          if(biggest1081990797 == 1){
            active[7]=1;
            ends[7]=1;
            break RUN;
            }
          //FINXME code
if(biggest1081990797 == 0){
            S755=0;
active[7]=0;
            ends[7]=0;
S755=0;
