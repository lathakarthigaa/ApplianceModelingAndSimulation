...
public class DishwasherR1A2 extends ClockDomain{
	...
	private int tutu__567981590;
	private int tutu__787232447;
	private int tutu__565673097;
	private int tutu__1850707712;
	private int S503 = 1;
	private int S269 = 1;
	private int S501 = 1;
	private int S271 = 1;
	...
	private int[] tdone = new int[85];
		public void thread1085068788(int [] tdone, int [] ends){
          if(tdone[6] != 1){
            switch(S501){
              case 0 : 
              active[6]=0;
...
if(appliancePowerDishwasherR1A2_o.get_preempted()){
                                        tutu__787232447 = 0;
                                        tutu__787232447 = appliancePowerDishwasherR1A2_o.get_preempted() ? appliancePowerDishwasherR1A2_o.refresh() : 0;
                    S278=1;
active[6]=1;
                    ends[6]=1;
tdone[6]=1;
...
if(appliancePowerDishwasherR1A2_o.get_w_s() == appliancePowerDishwasherR1A2_o.get_w_r()){
                                            tutu__567981590 = 0;
                                            tutu__567981590 = appliancePowerDishwasherR1A2_o.get_w_s();
                                            tutu__567981590++;
                                            appliancePowerDishwasherR1A2_o.set_w_s(tutu__567981590);
...
tdone[6]=1;
                ...
                switch(S278){
                  ...
                  if(appliancePowerDishwasherR1A2_o.get_preempted()){
                                        tutu__1850707712 = 0;
                                        tutu__1850707712 = appliancePowerDishwasherR1A2_o.get_preempted() ? appliancePowerDishwasherR1A2_o.refresh() : 0;
                    S278=1;
active[6]=1;
                    ends[6]=1;
tdone[6]=1;
                    ...
                    switch(S273){
                      ...
                      if(appliancePowerDishwasherR1A2_o.get_w_s() == appliancePowerDishwasherR1A2_o.get_w_r()){
                                                tutu__565673097 = 0;
                                                tutu__565673097 = appliancePowerDishwasherR1A2_o.get_w_s();
                                                tutu__565673097++;
                                                appliancePowerDishwasherR1A2_o.set_w_s(tutu__565673097);
                                                appliancePowerDishwasherR1A2_o.set_value(new Integer(power_thread_6));
                        S273=1;
if(appliancePowerDishwasherR1A2_o.get_w_s() == appliancePowerDishwasherR1A2_o.get_w_r()){
                                                    ends[6]=2;
...
public void thread1170098295(int [] tdone, int [] ends){
          if(tdone[5] != 1){
            switch(S269){
              case 0 : 
              active[5]=0;
...
public void thread1167789801(int [] tdone, int [] ends){
          if(tdone[6] != 1){
            S501=1;
S271=0;
active[6]=1;
...
public void thread1165096559(int [] tdone, int [] ends){
          if(tdone[5] != 1){
            S269=1;
if(onSignal.getprestatus()){
                            System.out.println("Dishwasher ON signal received");
...
RUN: while(true){
          ...
          thread1165096559(tdone,ends);
          thread1167789801(tdone,ends);
          int biggest1168174550 = 0;
          if(ends[5]>=biggest1168174550){
            biggest1168174550=ends[5];
}
          if(ends[6]>=biggest1168174550){
            biggest1168174550=ends[6];
}
          if(biggest1168174550 == 1){
            active[4]=1;
            ends[4]=1;
            break RUN;
            }
                    case 2 : 
                    powerReceive_4.setClear();
          thread1170098295(tdone,ends);
          thread1085068788(tdone,ends);
          int biggest1087377281 = 0;
          if(ends[5]>=biggest1087377281){
            biggest1087377281=ends[5];
}
          if(ends[6]>=biggest1087377281){
            biggest1087377281=ends[6];
}
          if(biggest1087377281 == 1){
            active[4]=1;
            ends[4]=1;
            break RUN;
            }
          //FINXME code
if(biggest1087377281 == 0){
            S503=0;
active[4]=0;
            ends[4]=0;
S503=0;
